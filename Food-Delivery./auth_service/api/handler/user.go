...
import (
	...
	token "delivery/auth_service/token"
...
// @Produce  json
// @Security  		BearerAuth
// @Param  profile  body  pb.UpdateModel  true  "Profile data"
...
func (h *Handler) UpdateProfile(c *gin.Context) {
	...
	_, err = h.AuthS.UpdateProfile(c, &req)
	if err != nil {
		c.JSON(500, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) ChangePassword(c *gin.Context) {
	...
	_, err = h.AuthS.ChangePassword(c, &req)
	if err != nil {
		c.JSON(500, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) ResetPassword(c *gin.Context) {
	...
	_, err := h.AuthS.ResetPassword(c, &req)
	if err != nil {
		c.JSON(500, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) GetUserProfile(c *gin.Context) {
	...
	userProfile, err := h.AuthS.GetUserProfile(c, &req)
	if err != nil {
		c.JSON(500, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) ConfirmEmail(c *gin.Context) {
	...
	_, err := h.AuthS.ConfirmEmail(c, &req)
	if err != nil {
		c.JSON(500, gin.H{"error": err.Error()})
		return
	}
...
func (h *Handler) ResendCode(c *gin.Context) {
	...
	_, err := h.AuthS.ResendCode(c, &req)
	if err != nil {
		c.JSON(500, gin.H{"error": err.Error()})
		return
	}
