...
const (
	ProductService_CreateProduct_FullMethodName = "/submodule.ProductService/CreateProduct"
	ProductService_GetProduct_FullMethodName    = "/submodule.ProductService/GetProduct"
	ProductService_UpdateProduct_FullMethodName = "/submodule.ProductService/UpdateProduct"
	ProductService_DeleteProduct_FullMethodName = "/submodule.ProductService/DeleteProduct"
	ProductService_ListProducts_FullMethodName  = "/submodule.ProductService/ListProducts"
)
...
type ProductServiceClient interface {
	CreateProduct(ctx context.Context, in *ProductCreateReq, opts ...grpc.CallOption) (*Void, error)
	GetProduct(ctx context.Context, in *ById, opts ...grpc.CallOption) (*ProductGet, error)
	UpdateProduct(ctx context.Context, in *ProductCreateReq, opts ...grpc.CallOption) (*Void, error)
...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *ProductCreateReq, opts ...grpc.CallOption) (*Void, error) {
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *ProductCreateReq, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
...
type ProductServiceServer interface {
	CreateProduct(context.Context, *ProductCreateReq) (*Void, error)
	GetProduct(context.Context, *ById) (*ProductGet, error)
	UpdateProduct(context.Context, *ProductCreateReq) (*Void, error)
...
func (UnimplementedProductServiceServer) CreateProduct(context.Context, *ProductCreateReq) (*Void, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateProduct not implemented")
}
func (UnimplementedProductServiceServer) GetProduct(context.Context, *ById) (*ProductGet, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetProduct not implemented")
}
func (UnimplementedProductServiceServer) UpdateProduct(context.Context, *ProductCreateReq) (*Void, error) {
...
func _ProductService_UpdateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).UpdateProduct(ctx, req.(*ProductCreateReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "submodule.ProductService",
