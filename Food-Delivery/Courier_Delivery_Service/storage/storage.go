...
import (
	...
	auth "courier_delivery/genproto/user"
)
...
type AuthServiceInterface interface {
	UserRegister(ctx context.Context, req *auth.UserRegisterRequest) (*auth.UserRegisterResponse, error)
	UserLogin(ctx context.Context, req *auth.UserLoginRequest) (*auth.UserLoginResponse, error)
	CreateUser(ctx context.Context, req *auth.CreateUserRequest) (*auth.UserResponse, error)
	GetUser(ctx context.Context, req *auth.UserRequest) (*auth.UserResponse, error)
	...
	UpdateCourier(ctx context.Context, req *auth.UpdateCourierRequestAuth) (*auth.CourierResponseAuth, error)
	DeleteCourier(ctx context.Context, req *auth.CourierRequestAuth) (*auth.CourierResponseAuth, error)
}
