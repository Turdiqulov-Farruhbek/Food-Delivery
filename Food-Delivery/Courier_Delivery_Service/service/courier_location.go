...
func NewCourierLocationService(store storage.StorageInterface, log logger.Logger) *CourierLocationService {
...
func (s *CourierLocationService) CreateCourierLocation(ctx context.Context, req *genproto.CreateCourierLocationRequest) (*genproto.CourierLocationResponse, error) {
...
func (s *CourierLocationService) GetCourierLocation(ctx context.Context, req *genproto.GetCourierLocationRequest) (*genproto.CourierLocationResponse, error) {
...
func (s *CourierLocationService) UpdateCourierLocation(ctx context.Context, req *genproto.UpdateCourierLocationRequest) (*genproto.CourierLocationResponse, error) {
...
func (s *CourierLocationService) DeleteCourierLocation(ctx context.Context, req *genproto.DeleteCourierLocationRequest) (*genproto.DeleteCourierLocationResponse, error) {
...
func (s *CourierLocationService) GetAllCourierLocations(ctx context.Context, req *genproto.GetAllCourierLocationsRequest) (*genproto.GetAllCourierLocationsResponse, error) {
