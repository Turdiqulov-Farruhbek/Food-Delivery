CREATE TABLE Users (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP -- Foydalanuvchi yaratilgan vaqti
);
...
CREATE TABLE Couriers (
    ...
    status Courier_status DEFAULT 'available', -- Kuryer holati ('available', 'unavailable', 'on_delivery')
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP -- Kuryer yaratilgan vaqti
);
