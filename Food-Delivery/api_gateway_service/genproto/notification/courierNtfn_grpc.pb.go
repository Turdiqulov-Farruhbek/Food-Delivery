...
type CourierNotificationServiceClient interface {
	...
	ListCourierNotifications(ctx context.Context, in *EmptyCourier, opts ...grpc.CallOption) (*CourierNotificationListResponse, error)
}
...
func (c *courierNotificationServiceClient) ListCourierNotifications(ctx context.Context, in *EmptyCourier, opts ...grpc.CallOption) (*CourierNotificationListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CourierNotificationServiceServer interface {
	...
	// Barcha kuryer bildirishnomalarini olish
	ListCourierNotifications(context.Context, *EmptyCourier) (*CourierNotificationListResponse, error)
...
func (UnimplementedCourierNotificationServiceServer) ListCourierNotifications(context.Context, *EmptyCourier) (*CourierNotificationListResponse, error) {
...
func _CourierNotificationService_ListCourierNotifications_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CourierNotificationServiceServer).ListCourierNotifications(ctx, req.(*EmptyCourier))
	}
	return interceptor(ctx, in, info, handler)
}
